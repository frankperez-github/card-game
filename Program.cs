namespace card_gameProtot
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            CardsInventary.Add(new Relics(defaultPlayer, defaultPlayer, 9, "El ojo blanco", 0, 2, "imgpath4", false, "show", "(Enemy.Show.all)"));

            // El ojo negro
            // Muestra 2 cartas de la mano del enemigo
            CardsInventary.Add(new Relics(defaultPlayer, defaultPlayer, 10, "El ojo negro", 0, 2, "imgpath4", false, "show", "(Enemy.Show.2)"));
